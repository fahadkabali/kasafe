...
const InputField: React.FC<InputFieldProps> = ({ type, name, placeholder, label, icon: Icon }) => (
  <div className="mb-4">
    ...
    <div className="relative">
      <input
        ...
        className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 text-dark focus:border-primary focus:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white"
        required
      />
      {Icon && (
    ...
    <form className="w-full" onSubmit={handleSubmit}>
      ...
      <div className="mb-6 flex items-center justify-between">
        <label className="flex items-center space-x-2">
          ...
          />
          <span className="text-sm font-medium text-gray-700 dark:text-gray-200">Remember me</span>
        </label>
      ...
      <button
        type="submit"
        className="w-full rounded-lg bg-blue-600 py-3 px-4 text-center text-sm font-semibold text-white shadow-sm hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
      >
        Sign In
      </button>
    </form>
